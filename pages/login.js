      ...
      <div className="w-full max-w-md space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Or
            <Link href={'/signup'} passHref legacyBehavior><a href="#" className="mx-2 font-medium text-indigo-600 hover:text-indigo-500">Sign Up</a></Link>
          </p>
        </div>
        <form onSubmit={handleSubmit} className="mt-8 space-y-6" method="POST">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <Link href={'/forgot'} passHref legacyBehavior><a href="#" className="font-medium text-indigo-600 hover:text-indigo-500">Forgot your password?</a></Link>
            </div>
          </div>
