  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">Ecommerce.com</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Order Id : #8977</h1>
        <p className="leading-relaxed mb-4">Your Order has been successfully placed</p>
        <div className="flex mb-4">
          <a className="text-center flex-grow    py-2 text-lg px-1">Item Description</a>
          <a className="text-center flex-grow  border-gray-300 py-2 text-lg px-1">Quatity</a>
          <a className="text-center flex-grow  border-gray-300 py-2 text-lg px-1">Item Total</a>
        </div>
