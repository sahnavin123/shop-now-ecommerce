...
const Checkout = ({ cart, subTotal, addToCart, removeFromCart }) => {
    return (
        <div className='container sm:m-auto mx-2'>
            ...
            <div className="mx-4">
                <Link href={'/checkout'}>
                    <button className='flex  mr-2 text-white  py-2 bg-indigo-600 border-0 hover:bg-indigo-700 px-2  focus:outline-none rounded-md text-md'><BsFillBagFill className='m-1' />Pay ₹ {subTotal}</button>
                </Link>
            </div>
